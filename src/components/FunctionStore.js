...
export const convertUnixToDateTime = (unixTimestamp, timezoneOffset) => {
...
export const convertUnixToTimeUTC = (unixTimestamp) => {
    const localDateTime = DateTime.fromSeconds(unixTimestamp).setZone('UTC');
    return localDateTime.toFormat('hh:mm a');
};

export const convertUnixToDateUTC = (unixTimestamp) => {
    const localDateTime = DateTime.fromSeconds(unixTimestamp).setZone('UTC');
